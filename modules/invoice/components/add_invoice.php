...
?>
                    ...
                    <table class="order-table">
                        ...
                        <tbody id="cart-body">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="autocomplete">
                                        <input type="text" id="item-name-1" class="autocomplete-input in-item-name" placeholder="Enter Item Name..." oninput="searchProductNameOnInput(event,1)" name="item-name[]" onclick="checkCustomer()" readonly>
        ...
        <script src="<?= MODULES . '/invoice/js/add_invoice.js' ?>"></script>
        <script>
            $.ajax({
                url: '<?= MODULES . '/invoice/ajax/fetch_last_invoice_number.php' ?>',
                type: 'POST',
            ...
            function confirmInvoice() {
                $.ajax({
                    url: '<?= MODULES . '/invoice/components/confirm_invoice_popup.php?type=confirm&page_id=7&access=1' ?>',
                    type: 'POST',
