...
if (isset($_SERVER['HTTP_X_REQUESTED_WITH']) && ($_SERVER['HTTP_X_REQUESTED_WITH'] == 'XMLHttpRequest')) {
    try {
        ...
        $response = callProcedure('fetch_invoice_card_details');
        ...
        if ($response['status'] == 'success') {
            ...
            $result = [
                'status' => 'success',
                'total_invoice_count' => $data['TotalInvoice'],
                'total_active_invoice_count' => $data['TotalActiveInvoice'],
                'total_inactive_invoice_count' => $data['TotalInactiveInvoice']
            ];
