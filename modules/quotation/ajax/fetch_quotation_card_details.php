...
if (isset($_SERVER['HTTP_X_REQUESTED_WITH']) && ($_SERVER['HTTP_X_REQUESTED_WITH'] == 'XMLHttpRequest')) {
    try {
        ...
        $response = callProcedure('fetch_quotation_card_details');
        ...
        if ($response['status'] == 'success') {
            ...
            $result = [
                'status' => 'success',
                'total_quotation_count' => $data['TotalQuotations'],
                'total_active_quotation_count' => $data['TotalActiveQuotations'],
                'total_inactive_quotation_count' => $data['TotalInactiveQuotations']
            ];
