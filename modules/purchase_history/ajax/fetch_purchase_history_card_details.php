...
if (isset($_SERVER['HTTP_X_REQUESTED_WITH']) && ($_SERVER['HTTP_X_REQUESTED_WITH'] == 'XMLHttpRequest')) {
    try {
        ...
        $response = callProcedure('fetch_purchase_history_card_details');
        ...
        if ($response['status'] == 'success') {
            ...
            $result = [
                'status' => 'success',
                'total_purchases_count' => $data['TotalPurchases'],
                'total_active_purchases_count' => $data['TotalActivePurchases'],
                'total_inactive_purchases_count' => $data['TotalInactivePurchases']
            ];
