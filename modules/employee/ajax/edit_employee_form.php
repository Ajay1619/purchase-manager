...
if (isset($_SERVER['HTTP_X_REQUESTED_WITH']) && ($_SERVER['HTTP_X_REQUESTED_WITH'] == 'XMLHttpRequest')) {
    ...
    $employeeAccountId = isset($_POST['employee-account-id']) ? sanitizeInput($_POST['employee-account-id'], 'string') : '';
    ...
    if (!empty($errors)) {
        ...
        if (isset($_POST['previous-logo']) && !empty($_POST['previous-logo'])) {
            ...
            $employeePhotoPath = $previous_logo;
        } else {
        ...
        $procedure_params = [
            ['value' => $employeeAccountId, 'type' => 'i'], // p_employee_name
        ...
        try {
            $result = callProcedure('update_employee_account', $procedure_params); // Ensure you have this stored procedure created
