...
<head>
    ...
    <link rel="stylesheet" href="<?= MODULES . '/vendor_invoice/css/invoice.css' ?>">
...
<body>
    ...
    <script>
        ...
        function invoice_home() {
            ...
            $.ajax({
                type: 'POST',
                url: '<?= MODULES . '/vendor_invoice/components/invoice_home.php?page_id=6&access=0' ?>',
                success: function(response) {
        ...
        function add_invoice() {
            $.ajax({
                type: 'POST',
                url: '<?= MODULES . '/vendor_invoice/components/add_invoice.php?type=add&page_id=7&access=0' ?>',
                success: function(response) {
                    $('#invoice').html(response);
        ...
        function view_invoice(invoice_id) {
            $.ajax({
                type: 'POST',
                url: '<?= MODULES . '/vendor_invoice/components/view_invoice.php?type=view&page_id=9&access=0' ?>',
                data: {
        ...
        function fetch_product(product_id, count) {
            $.ajax({
                url: '<?= MODULES . '/vendor_invoice/json/fetch_product.php' ?>',
                type: 'POST',
                data: {
        ...
        function calculateInvoice() {
            $.ajax({
                url: '<?= MODULES . '/vendor_invoice/ajax/calculate_invoice.php' ?>',
                type: 'POST',
