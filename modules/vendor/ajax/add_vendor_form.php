    ...
    if (isset($_SERVER['HTTP_X_REQUESTED_WITH']) && ($_SERVER['HTTP_X_REQUESTED_WITH'] == 'XMLHttpRequest')) {
        ...
        $shipping_pincode = isset($_POST['shipping-pincode']) ? sanitizeInput($_POST['shipping-pincode'], 'int') : '';
        ...
        if (!empty($errors)) {
            ...
            try {
                $result = callProcedure('insert_vendor', $procedure_params);
                echo json_encode(['status' => 'success', 'message' => 'Vendor inserted successfully.']);
            } catch (Exception $e) {
